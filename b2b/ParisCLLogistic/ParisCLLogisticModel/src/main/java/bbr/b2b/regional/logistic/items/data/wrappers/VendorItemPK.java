...
public class VendorItemPK implements IVendorItemPK {
	...
	public VendorItemPK(Long vendorid, Long itemid){
	...
	public boolean equals(Object o){
		if (o != null && o instanceof VendorItemPK){
			VendorItemPK that = (VendorItemPK) o;
