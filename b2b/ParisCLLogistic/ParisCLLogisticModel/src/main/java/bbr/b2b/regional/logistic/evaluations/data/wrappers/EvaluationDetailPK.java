...
public class EvaluationDetailPK implements IEvaluationDetailPK {

	private Long receptionevaluationid;
	private Long receptionerrorid;

	public EvaluationDetailPK(){
	}
	public EvaluationDetailPK(Long receptionevaluationid, Long receptionerrorid){
	...
	public boolean equals(Object o){
		if (o != null && o instanceof EvaluationDetailPK){
			EvaluationDetailPK that = (EvaluationDetailPK) o;
