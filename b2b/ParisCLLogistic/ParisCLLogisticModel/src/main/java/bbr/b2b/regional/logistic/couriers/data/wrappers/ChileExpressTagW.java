...
public class ChileExpressTagW extends CourierTagW implements IChileExpressTag {
	...
	public boolean isCourierTag() {
		return courierTag;
	}
	public void setCourierTag(boolean courierTag) {
