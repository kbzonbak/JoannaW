...
public class DirectOrderDetailPK implements IDirectOrderDetailPK {

	private Long orderid;
	private Long itemid;

	public DirectOrderDetailPK(){
	}
	public DirectOrderDetailPK(Long orderid, Long itemid){
	...
	public boolean equals(Object o){
		if (o != null && o instanceof DirectOrderDetailPK){
			DirectOrderDetailPK that = (DirectOrderDetailPK) o;
