...
public class ErrorFactorPK implements IErrorFactorPK {

	private Long evaluationcriteriaid;
	private Long receptionerrorid;

	public ErrorFactorPK(){
	}
	public ErrorFactorPK(Long evaluationcriteriaid, Long receptionerrorid){
	...
	public boolean equals(Object o){
		if (o != null && o instanceof ErrorFactorPK){
			ErrorFactorPK that = (ErrorFactorPK) o;
