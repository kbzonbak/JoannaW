...
public class PreDeliveryDetailPK implements IPreDeliveryDetailPK {

	private Long orderid;
	private Long itemid;
	private Long locationid;

	public PreDeliveryDetailPK(){
	}
	public PreDeliveryDetailPK(Long orderid, Long itemid, Long locationid){
	...
	public boolean equals(Object o){
		if (o != null && o instanceof PreDeliveryDetailPK){
			PreDeliveryDetailPK that = (PreDeliveryDetailPK) o;
