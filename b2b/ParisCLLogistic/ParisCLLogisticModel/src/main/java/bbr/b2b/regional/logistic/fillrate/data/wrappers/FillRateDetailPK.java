...
public class FillRateDetailPK implements IFillRateDetailPK {

	private Long fillrateid;
	private Long itemid;

	public FillRateDetailPK(){
	}
	public FillRateDetailPK(Long fillrateid, Long itemid){
	...
	public boolean equals(Object o){
		if (o != null && o instanceof FillRateDetailPK){
			FillRateDetailPK that = (FillRateDetailPK) o;
