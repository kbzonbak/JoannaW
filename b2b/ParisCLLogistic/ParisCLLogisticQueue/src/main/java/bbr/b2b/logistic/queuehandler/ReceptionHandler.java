...
public class ReceptionHandler implements ReceptionHandlerLocal {
	...
	public void handleMessage(String content, javax.ejb.MessageDrivenContext ctx) throws OperationFailedException, NotFoundException {
		...
		try {
			...
			logger.info("Inicio de carga de Recepción: " + receptionnumber);
			...
			logger.info("Recepción" + receptionnumber + " cargado");
			...
			doSendResponse(receptionnumber.toString(), "RE", 0, "La recepción se cargo correctamente", now, content);
