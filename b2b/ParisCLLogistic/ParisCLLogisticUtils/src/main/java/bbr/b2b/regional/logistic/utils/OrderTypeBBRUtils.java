...
/*
 * en las propiedades del módulo deben, existir las siguentes lineas, donde 
 * 
...
public class OrderTypeBBRUtils {	
	...
	public String getOrderTypeBBRByID(Long ordertypeid) {
		if("CODE".equals(this.VALUETYPE)){
			logger.error("Se tiene configurado los códigos. Se debe usar el método getOrderTypeBBRByCode");
			return "";
		}
