...
public class VendorLocationId implements IVendorLocationPK {

	private Long vendorid;
	private Long locationid;

	public VendorLocationId(){
	}
	public VendorLocationId(Long vendorid, Long locationid){
	...
	public boolean equals(Object o){
		if (o != null && o instanceof VendorLocationId){
			VendorLocationId that = (VendorLocationId) o;
