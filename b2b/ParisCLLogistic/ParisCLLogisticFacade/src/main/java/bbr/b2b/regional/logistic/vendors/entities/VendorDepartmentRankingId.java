...
public class VendorDepartmentRankingId implements IVendorDepartmentRankingPK {

	private Long vendorid;
	private Long rankingid;
	private Long departmentid;

	public VendorDepartmentRankingId(){
	}
	public VendorDepartmentRankingId(Long vendorid, Long rankingid, Long departmentid){
	...
	public boolean equals(Object o){
		if (o != null && o instanceof VendorDepartmentRankingId){
			VendorDepartmentRankingId that = (VendorDepartmentRankingId) o;
