...
public class OutReceptionDetailId implements IOutReceptionDetailPK {
	...
	public OutReceptionDetailId(){
	}
	public OutReceptionDetailId(Long outreceptionid, Long orderid, Long itemid, Long locationid){
	...
	public boolean equals(Object o){
		if (o != null && o instanceof OutReceptionDetailId){
			OutReceptionDetailId that = (OutReceptionDetailId) o;
