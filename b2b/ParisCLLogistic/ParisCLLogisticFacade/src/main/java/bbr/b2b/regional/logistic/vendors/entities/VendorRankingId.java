...
public class VendorRankingId implements IVendorRankingPK {

	private Long vendorid;
	private Long rankingid;

	public VendorRankingId(){
	}
	public VendorRankingId(Long vendorid, Long rankingid){
	...
	public boolean equals(Object o){
		if (o != null && o instanceof VendorRankingId){
			VendorRankingId that = (VendorRankingId) o;
