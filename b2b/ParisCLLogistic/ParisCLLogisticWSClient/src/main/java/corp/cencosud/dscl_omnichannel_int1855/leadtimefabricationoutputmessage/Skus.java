...
package corp.cencosud.dscl_omnichannel_int1855.leadtimefabricationoutputmessage;
 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="skuName" minOccurs="0">
 *                     &lt;simpleType>
 *                       &lt;restriction base="{http://www.w3.org/2001/XMLSchema}string">
 *                         &lt;maxLength value="100"/>
 *                       &lt;/restriction>
 ...
 *                     &lt;/simpleType>
 *                   &lt;/element>
 *                   &lt;element name="leadTime" minOccurs="0">
 *                     &lt;simpleType>
...
public class Skus {
    ...
    protected Skus.Messages messages;
    @XmlElement(required = true)
    protected List<Skus.Sku> sku;
     ...
     *     
     */
    public Skus.Messages getMessages() {
        return messages;
    }
     ...
     *     
     */
    public void setMessages(Skus.Messages value) {
        this.messages = value;
    }
     ...
     * 
     */
    public List<Skus.Sku> getSku() {
        if (sku == null) {
            sku = new ArrayList<Skus.Sku>();
        }
        return this.sku;
    }
    ...
    public static class Messages {
        ...
        @XmlElement(required = true)
        protected List<Skus.Messages.Message> message;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link Skus.Messages.Message }
         * 
         * 
         */
        public List<Skus.Messages.Message> getMessage() {
            if (message == null) {
                message = new ArrayList<Skus.Messages.Message>();
            }
            return this.message;
        }
