...
public class VendorItePK implements IVendorItePK {
	...
	public VendorItePK(Long itemid, Long vendorid){
		this.itemid = itemid;
		this.vendorid = vendorid;
	}

	public boolean equals(Object o){
		if (o != null && o instanceof VendorItePK){
			VendorItePK that = (VendorItePK) o;
