...
public class DvrOrderDetailPK implements IDvrOrderDetaiPK {

	private Long dvrorderid;
	private Long itemid;
	private Integer position;

	public DvrOrderDetailPK(){
	}
	public DvrOrderDetailPK(Long dvrorderid, Long itemid, Integer position){
	...
	public boolean equals(Object o){
		if (o != null && o instanceof DvrOrderDetailPK){
			DvrOrderDetailPK that = (DvrOrderDetailPK) o;
