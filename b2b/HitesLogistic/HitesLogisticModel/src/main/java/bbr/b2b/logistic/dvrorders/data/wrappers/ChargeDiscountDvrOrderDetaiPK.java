...
public class ChargeDiscountDvrOrderDetaiPK implements IChargeDiscountDvrOrderDetaiPK {
	...
	public ChargeDiscountDvrOrderDetaiPK(){
	}
	public ChargeDiscountDvrOrderDetaiPK(Long dvrorderid, Long itemid, Integer position, Long chargediscountid){
	...
	public boolean equals(Object o){
		if (o != null && o instanceof ChargeDiscountDvrOrderDetaiPK){
			ChargeDiscountDvrOrderDetaiPK that = (ChargeDiscountDvrOrderDetaiPK) o;
