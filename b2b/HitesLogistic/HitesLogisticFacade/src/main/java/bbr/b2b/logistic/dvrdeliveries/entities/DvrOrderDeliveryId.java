...
public class DvrOrderDeliveryId implements IDvrOrderDeliveryPK {

	private Long dvrorderid;
	private Long dvrdeliveryid;

	public DvrOrderDeliveryId(){
	}
	public DvrOrderDeliveryId(Long dvrorderid, Long dvrdeliveryid){
		this.dvrorderid = dvrorderid;
		this.dvrdeliveryid = dvrdeliveryid;
	}

	public boolean equals(Object o){
		if (o != null && o instanceof DvrOrderDeliveryId){
			DvrOrderDeliveryId that = (DvrOrderDeliveryId) o;
