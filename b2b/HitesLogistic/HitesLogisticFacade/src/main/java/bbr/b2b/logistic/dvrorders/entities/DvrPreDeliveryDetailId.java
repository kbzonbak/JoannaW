...
public class DvrPreDeliveryDetailId implements IDvrPreDeliveryDetaiPK {
	...
	public DvrPreDeliveryDetailId(){
	}
	public DvrPreDeliveryDetailId(Long dvrorderid, Long itemid, Long locationid, Integer position){
	...
	public boolean equals(Object o){
		if (o != null && o instanceof DvrPreDeliveryDetailId){
			DvrPreDeliveryDetailId that = (DvrPreDeliveryDetailId) o;
