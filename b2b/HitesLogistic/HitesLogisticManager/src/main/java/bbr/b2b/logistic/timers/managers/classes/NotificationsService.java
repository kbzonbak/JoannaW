...
@Singleton
@DependsOn("managers/NotificationsTimerManager")
public class NotificationsService implements Scheduler {
	
	@Resource
    private TimerService timerService;

	private static Logger logger = Logger.getLogger(NotificationsService.class);	
	
	public static final String CRON_NAME = "Cron de Envío de Notificaciones Logisticas";
	public static final String JNDI_TIMER = "java:global/HitesLogisticEAR/HitesLogisticManager/NotificationsService!bbr.b2b.logistic.timers.managers.interfaces.Scheduler";
	
	@EJB
	private NotificationsTimerManagerLocal notificationsmanager;
		
	@Timeout
    public void scheduler(Timer timer) throws ServiceException{
		logger.info("Se ejecuta " + CRON_NAME);
    	
		notificationsmanager.execute();	
    }
    ...
    public void initialize(String info) {
    	...
    	long interval_in_minutes = LogisticConstants.getINTERVAL_MINUTE_NOTIFICATIONS_CRON();
