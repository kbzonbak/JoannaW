...
public class PendingMessagesService implements Scheduler {

	@Resource
	private TimerService timerService;

	private static Logger logger = Logger.getLogger(PendingMessagesService.class);

	public static final String CRON_NAME = "Cron de Envío de Mensajes al MQ";

	public static final String JNDI_TIMER = "java:global/HitesLogisticEAR/HitesLogisticManager/PendingMessagesService!bbr.b2b.logistic.timers.managers.interfaces.Scheduler";
	...
	public void scheduler(Timer timer) throws ServiceException {
		...
		if (!LogisticConstants.getENABLE_PENDING_MESSAGE_CRON()) {
			return;
		}
