...
//    
//    
// public static byte[] decryptWithPrivateKey(byte[] encrypted, InputStream keyIn,char[] passwd) throws IOException, PGPException, NoSuchProviderException{
//        
//    	InputStream in = new ByteArrayInputStream(encrypted);
//
//        in = PGPUtil.getDecoderStream(in);
...
//    }
//    
//    public static byte[] encryptWithPublicKey(byte[] clearData,PGPPublicKey encKey,String fileName,int algorithm,boolean armor) throws IOException, PGPException, NoSuchProviderException{
//        if (fileName == null)
//        {
//            fileName= PGPLiteralData.CONSOLE;
//        }
