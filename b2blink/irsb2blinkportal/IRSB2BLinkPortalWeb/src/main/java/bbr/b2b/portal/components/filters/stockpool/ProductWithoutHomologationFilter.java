...
public class ProductWithoutHomologationFilter extends BbrFilterContainer implements Button.ClickListener
{
	...
	public ProductWithoutHomologationFilter(BbrModule parentModule)
	{
		super(parentModule);
	}
	// =====================================================================================================================================
	...
	public void buttonClick(ClickEvent event)
	{
		...
		else
		{
			...
			ProductWithoutHomologationFilter.this.showWarningMessage(I18NManager.getI18NString(BbrUtilsResources.RES_GENERIC, "windows_title_warning"), errorMsg);
		}
	}
