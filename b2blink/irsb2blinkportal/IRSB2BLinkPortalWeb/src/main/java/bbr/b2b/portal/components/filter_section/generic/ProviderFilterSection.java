...
public class ProviderFilterSection extends BbrVerticalSection<CompanyDataDTO>
{
	...
	public ProviderFilterSection(BbrUI parent)
	{
		super(parent);
	}
	...
	{
		if (ProviderFilterSection.this.cbx_Providers != null && ProviderFilterSection.this.cbx_Providers.getSelectedValue() != null && e != null)
		{
			BbrSectionEvent bbrEvent = new BbrSectionEvent(BbrFilterSectionConstants.FS_PROVIDER);
			bbrEvent.setResultObject(ProviderFilterSection.this.cbx_Providers.getSelectedValue());
