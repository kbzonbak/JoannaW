...
//import bbr.b2b.portal.components.filters.tickets.ListSupervisorTicketsFilter;
//import bbr.b2b.portal.components.modules.tickets.SupervisorTicketDetails;
...
//
//public class ListSupervisorTickets extends BbrModule 
//{
//	// ****************************************************************************************
...
//	private final String ANALYST_USERNAME_FIELD		= "analystusername" ;
...
//	// ****************************************************************************************
//	public ListSupervisorTickets(BbrUI bbrUIParent) 
//	{
//		super(bbrUIParent);
//	}
//	// ****************************************************************************************
...
//	{
//		//Filtro del reporte
//		ListSupervisorTicketsFilter filterLayout = new ListSupervisorTicketsFilter();
...
//	{
//		SupervisorTicketDetails winViewTicketDetails = new SupervisorTicketDetails(selectedTicket,this.initParams.getVendorId());
...
//
//		BbrColumn<String> col_AnalystUser	= new BbrColumn<>(this.ANALYST_USERNAME_FIELD, String.class, I18NManager.getI18NString(BbrUtilsResources.RES_MODULES_TICKETS, "assigned_to_analyst"));
...
//
//				TicketReportResultDTO reportResult = EJBFactory.getTicketsEJBFactory().getTicketReportManagerLocal().getSupervisorTicketReportByFilter(initParams, true);
...
//						{
//							ListSupervisorTickets.this.askToOpenFilter(I18NManager.getI18NString(BbrUtilsResources.RES_GENERIC, "windows_title_info"), I18NManager.getI18NString(BbrUtilsResources.RES_FILTERS, "empty_filter_question"));
//						}
//						
//						askForFilter = true;
//					}
