...
//
//public class SupervisorTicketDetails extends BbrWindow 
//{
//	// ****************************************************************************************
...
//	// ****************************************************************************************
//	public SupervisorTicketDetails(TicketReportDataDTO selectedTicket, Long vendorId) 
//	{
...
//		{
//			//Reassign Button
//			Button btn_ReAssignTicket = new Button(I18NManager.getI18NString(BbrUtilsResources.RES_MODULES_TICKETS, "reassign_to_analyst"));
//			btn_ReAssignTicket.setStyleName("primary");
//			btn_ReAssignTicket.addStyleName("btn-login");
//			btn_ReAssignTicket.setWidth("170px");
//			btn_ReAssignTicket.addClickListener((ClickListener & Serializable) e -> btnReAssign_clickHandler(e));
//			
//			this.buttonsPanel.addComponent(btn_ReAssignTicket);
//		}
//		
//
//		//Cancel Button
...
//
//
//	private void btnReAssign_clickHandler(ClickEvent e) 
//	{
//		SendSupervisorTicketOperation winVendorTicketOperation 
//		= new SendSupervisorTicketOperation(this.selectedTicket,this.vendorId, this.vendorName,EnumTicketOperation.REASSIGN);
...
//			try 
//			{
//				TicketDetailReportResultDTO ticketResult = EJBFactory.getTicketsEJBFactory().getTicketReportManagerLocal().getSupervisorTicketDetailReport(initParams);
