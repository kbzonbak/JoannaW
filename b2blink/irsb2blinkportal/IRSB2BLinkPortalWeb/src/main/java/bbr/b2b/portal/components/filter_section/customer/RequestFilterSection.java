...
public class RequestFilterSection extends BbrVerticalSection<CompanyDataDTO>
{
	...
	public RequestFilterSection(BbrUI parent)
	{
		super(parent);
	}
	...
	{
		if (RequestFilterSection.this.cbx_Providers != null && RequestFilterSection.this.cbx_Providers.getSelectedValue() != null && e != null)
		{
			BbrSectionEvent bbrEvent = new BbrSectionEvent(BbrFilterSectionConstants.FS_PROVIDER);
			bbrEvent.setResultObject(RequestFilterSection.this.cbx_Providers.getSelectedValue());
