...
//import bbr.b2b.portal.components.filters.tickets.ListVendorsTicketsFilter;
//import bbr.b2b.portal.components.modules.tickets.AddVendorTicket;
//import bbr.b2b.portal.components.modules.tickets.VendorTicketDetails;
...
//
//public class ListVendorsTickets extends BbrModule 
//{
//	// ****************************************************************************************
...
//	// ****************************************************************************************
//	public ListVendorsTickets(BbrUI bbrUIParent) 
//	{
//		super(bbrUIParent);
//	}
//	// ****************************************************************************************
...
//	{
//		//Filtro del reporte
//		ListVendorsTicketsFilter filterLayout = new ListVendorsTicketsFilter();
...
//
//		Button btn_AddTicket 	= new Button("", BbrThemeResourcesUtils.getInstance().getResource(CoreConstants.PATH_BASE_IMAGES_BUTTONS+"icon_AddTicket.png"));
//		btn_AddTicket.setDescription(I18NManager.getI18NString(BbrUtilsResources.RES_MODULES_TICKETS, "add_ticket"));
//		btn_AddTicket.addClickListener((ClickListener & Serializable)e -> addTicket_clickHandler(e));
//		btn_AddTicket.addStyleName("toolbar-button");
//		
//		leftButtonsBar.addComponents(btn_ViewDetails, btn_AddTicket);
//
//
...
//	}
//
//	private void addTicket_clickHandler(ClickEvent e) 
//	{
//		AddVendorTicket winAddVendorTicket = new AddVendorTicket();
//		winAddVendorTicket.initializeView();
//		winAddVendorTicket.addBbrEventListener((BbrEventListener & Serializable) event -> ticketCreated_handler(event));		
//		winAddVendorTicket.open(getBbrUIParent(), true);
//	}
//	
//	private void ticketCreated_handler(BbrEvent event) 
//	{
//		if(event.getEventType().equals(BbrEvent.ITEM_CREATED))
//		{
//			this.updateReport(initParams, false, true,true);
//		}
//	}
//
...
//	{
//		VendorTicketDetails winViewVendorTicketDetails = new VendorTicketDetails(selectedTicket,this.initParams.getVendorId());
//		winViewVendorTicketDetails.addBbrEventListener((BbrEventListener & Serializable) event -> ticketUpdated_handler(event));		
//		winViewVendorTicketDetails.initializeView();
//		winViewVendorTicketDetails.open(getBbrUIParent(), true);
//	}
//
//	// ****************************************************************************************
...
//
//				TicketReportResultDTO reportResult = EJBFactory.getTicketsEJBFactory().getTicketReportManagerLocal().getVendorTicketReportByFilter(initParams, true);
...
//						{
//							ListVendorsTickets.this.askToOpenFilter(I18NManager.getI18NString(BbrUtilsResources.RES_GENERIC, "windows_title_info"), I18NManager.getI18NString(BbrUtilsResources.RES_FILTERS, "empty_filter_question"));
//						}
//						
//						askForFilter = true;
//					}
