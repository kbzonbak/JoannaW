...
public class ExpirationsPanel extends VerticalLayout 
{
	// ****************************************************************************************
...
//		result.setWidth("100%");
//
//		Label headerCaption = new Label(I18NManager.getI18NString(BbrUtilsResources.RES_MODULES_WALLDIARY, "expirations"));
...
//		
//		leftMenuBar.addItem("", FontAwesome.BAR_CHART, null);
//
...
////		try 
////		{
////			PublishingReportResultDTO activePublishingResult = EJBFactory.getUserEJBFactory().getPublishingManagerLocal().getActivePublishingsByType(BbrAppConstants.NOVELTIES_PUBLISHING_CODE);
