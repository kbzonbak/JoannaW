...
public class CreateEditProceduresNotification extends BbrWindow
{
	// ****************************************************************************************
	...
	// ****************************************************************************************
	public CreateEditProceduresNotification(BbrUI parent, PublishingReportDataDTO selectedNotification)
	{
		super(parent);
	...
	private void create_SetActive_Handler(NotificationInfo notificationInfo, boolean activate)
	{
		...
		notificationInfo.setIsActive(this.isActive);
