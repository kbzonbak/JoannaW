...
//import bbr.b2b.portal.classes.wrappers.tickets.ListVendorsTicketsInfo;
...
//
//public class ListVendorsTicketsFilter extends BbrFilterContainer implements Button.ClickListener
//{
//
//	// ****************************************************************************************
...
//	// ****************************************************************************************
//	public ListVendorsTicketsFilter() 
//	{
//	}
//	// ****************************************************************************************
...
//	{
//		
//		ListVendorsTicketsInfo filterInfo = new ListVendorsTicketsInfo(cbx_FilterType.getSelectedValue().getId(), cbx_Providers.getSelectedValue(), 
...
//			ListVendorsTicketsFilter.this.showWarningMessage(I18NManager.getI18NString(BbrUtilsResources.RES_GENERIC, "windows_title_warning"), errorMsg);
//		}
//
//
//
