...
//import bbr.b2b.portal.classes.wrappers.tickets.ListAnalystTicketsInfo;
...
//
//public class ListAnalystTicketsFilter extends BbrFilterContainer implements Button.ClickListener
//{
//
//	// ****************************************************************************************
...
//	// ****************************************************************************************
//	public ListAnalystTicketsFilter() 
//	{
//	}
//	// ****************************************************************************************
...
//	{
//
//		ListAnalystTicketsInfo filterInfo = new ListAnalystTicketsInfo(cbx_FilterType.getSelectedValue().getId(), cbx_Providers.getSelectedValue(), 
//				txtNumber.getValue(), this.getBbrUIParent().getUser());
...
//			ListAnalystTicketsFilter.this.showWarningMessage(I18NManager.getI18NString(BbrUtilsResources.RES_GENERIC, "windows_title_warning"), errorMsg);
//		}
//
//
//
...
//		if(userBean != null)
//		{
//			SearchCriterion[] searcCriterions = SearchFilterUtils.getInstance().getListVendorTicketsFilterCriteria();
//
...
//						companiesResult = EJBFactory.getFinancesEJBFactory().getFinancesReportManagerLocal().getCompanyById(user.getEnterpriseId());
