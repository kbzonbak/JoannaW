...
import bbr.b2b.portal.marketplace.managers.classes.MarketPlaceManagerLocal;
...
public class MarketPlaceEJBFactory {

	// ****************************************************************************************
		// BEGINNING SECTION ----> PROPERTIES
		// ****************************************************************************************
		private static MarketPlaceEJBFactory _instance = new MarketPlaceEJBFactory();
		...
		// ****************************************************************************************
		public MarketPlaceManagerLocal getMarketPlaceManagerLocal() throws BbrUserException, BbrSystemException
		{
			return getMarketPlaceManagerLocal((BbrUI) UI.getCurrent());
		}

		public MarketPlaceManagerLocal getMarketPlaceManagerLocal(BbrUI bbrUI) throws BbrUserException, BbrSystemException
		{
			this.validateUserSystem(bbrUI);
			MarketPlaceManagerLocal manager = (MarketPlaceManagerLocal) getEJBHomes("MarketPlaceManagerLocal");
			return manager;
		}

		public MarketPlaceManagerLocal getMarketPlaceManagerLocal(BbrUI bbrUI, String companycode) throws BbrUserException, BbrSystemException
		{
		...
		// ****************************************************************************************
		protected static MarketPlaceEJBFactory getFactory()
		{
			return _instance;
		}
