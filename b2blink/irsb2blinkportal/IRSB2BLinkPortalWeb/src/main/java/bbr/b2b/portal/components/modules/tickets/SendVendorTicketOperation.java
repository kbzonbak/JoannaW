...
//
//public class SendVendorTicketOperation extends BbrWindow 
//{
//	// ****************************************************************************************
...
//	// ****************************************************************************************
//	public SendVendorTicketOperation(BbrUI parent, TicketReportDataDTO selectedTicket, Long vendorId, String vendorName, EnumTicketOperation ticketOperation) 
//	{
//		super(parent);
...
//	{
//		VendorTicketOperationInfo vendorTicketInfo = new VendorTicketOperationInfo(this.selectedTicket, this.vendorId, 
//				this.vendorName, this.ckEditorTextField.getValue(),this.ticketOperation);
//		//Create
...
//						break;
//					case CLOSE:
//						ticketResult 	= EJBFactory.getTicketsEJBFactory().getTicketReportManagerLocal().doCloseVendorTicket(initParams);
//						break;
//					case REOPEN:
//						ticketResult 	= EJBFactory.getTicketsEJBFactory().getTicketReportManagerLocal().doReOpenVendorTicket(initParams);
//						break;
//					case REPLY:
//						ticketResult 	= EJBFactory.getTicketsEJBFactory().getTicketReportManagerLocal().doResponseVendorTicket(initParams);
//						break;
//
//					default:
//						break;
