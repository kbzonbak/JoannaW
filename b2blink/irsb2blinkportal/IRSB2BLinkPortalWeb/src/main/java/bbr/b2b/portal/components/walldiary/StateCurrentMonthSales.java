...
public class StateCurrentMonthSales extends VerticalLayout
{
	...
	public StateCurrentMonthSales(BbrUI bbrUI, double amount)
	{
		this.bbrUI = bbrUI;
		this.amount = amount;
	...
	private void initializeControl()
	{
		if (bbrUI != null && bbrUI.getUser() != null)
		{
			...
			Resource res = BbrThemeResourcesUtils.getInstance().getResource(bbrUI, CoreConstants.PATH_BASE_IMAGES_WALLDIARY + "state_current_month_sales.png");
	...
	private HorizontalLayout getToolBar()
	{
		...
		Label headerCaption = new Label(I18NManager.getI18NString(bbrUI, BbrUtilsResources.RES_MODULES_WALLDIARY, "current_month_sales"));
	...
	public void updateData(double amount, LocalDateTime localDate)
	{
		if (localDate != null)
		{
			this.amount = amount;

			String date = localDate.format(DateTimeFormatter.ofPattern("MMMM YYYY").withLocale(bbrUI.getUser().getLocale()));
			String dataValue = String.valueOf(df.format(this.amount / 1000000));
