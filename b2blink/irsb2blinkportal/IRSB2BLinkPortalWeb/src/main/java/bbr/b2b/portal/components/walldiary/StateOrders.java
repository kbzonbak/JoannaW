...
public class StateOrders extends VerticalLayout 
{
	// ****************************************************************************************
	...
	private void initializeControl()
	{
		...
		Label lblData = new Label("784");				
		lblData.setStyleName("lbl-state-orders");
		Label lblDetailData = new Label("0,21 %");
		lblDetailData.setStyleName("lblDetail-state-orders");
		String res_logo = this.getPropertyValue(BbrUtilsResources.RES_B2B_PAGES, "state_orders");
		Resource res = new ThemeResource(res_logo);
		Image imgData = new Image(null, res);
		imgData.setStyleName("image-state-orders");		
	...
	private HorizontalLayout getToolBar()
	{
		...
		result.addStyleName("stats-header-orders");
		result.setWidth("100%");

		Label headerCaption = new Label(I18NManager.getI18NString(BbrUtilsResources.RES_MODULES_WALLDIARY, "orders"));
