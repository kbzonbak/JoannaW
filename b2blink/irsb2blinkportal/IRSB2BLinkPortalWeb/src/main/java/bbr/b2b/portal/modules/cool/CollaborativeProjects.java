...
public class CollaborativeProjects extends BbrModule 
{
	// ****************************************************************************************
	...
	// ****************************************************************************************
	public CollaborativeProjects(BbrUI bbrUIParent) 
	{
		super(bbrUIParent);
	}
	// ****************************************************************************************
	...
	public void initializeView() 
	{
		...
		if(user != null)
		{
			...
			Resource res = BbrThemeResourcesUtils.getInstance().getResource(this.getBbrUIParent(),"assets/images/modules/collaborative_projects.jpg");
