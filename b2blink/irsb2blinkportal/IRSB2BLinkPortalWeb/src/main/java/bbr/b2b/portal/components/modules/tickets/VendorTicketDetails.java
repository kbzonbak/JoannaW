...
//import bbr.b2b.portal.classes.wrappers.management.VendorTicketOperationInfo;
...
//
//public class VendorTicketDetails extends BbrWindow 
//{
//	// ****************************************************************************************
...
//	// ****************************************************************************************
//	public VendorTicketDetails(TicketReportDataDTO selectedTicket, Long vendorId) 
//	{
...
//		
//		if(this.selectedTicket.getCodestatus().equalsIgnoreCase(TicketsConstants.TICKET_WAITING_RESPONSE))
//		{
//			//Reply Button
...
//		{
//			//Reopen Button
//			Button btn_Reopen = new Button(I18NManager.getI18NString(BbrUtilsResources.RES_MODULES_TICKETS, "reopen"));
//			btn_Reopen.setStyleName("primary");
//			btn_Reopen.addStyleName("btn-login");
//			btn_Reopen.setWidth("170px");
//			btn_Reopen.addClickListener((ClickListener & Serializable) e -> btnReopen_clickHandler(e));
//			
//			
//			//Accept Button
//			Button btn_Accept = new Button(I18NManager.getI18NString(BbrUtilsResources.RES_MODULES_TICKETS, "accept_solution"));
//			btn_Accept.setStyleName("primary");
//			btn_Accept.addStyleName("btn-login");
//			btn_Accept.setWidth("170px");
//			btn_Accept.addClickListener((ClickListener & Serializable) e -> btnAccept_clickHandler(e));
//			
//			this.buttonsPanel.addComponents(btn_Reopen, btn_Accept);
//		}
//		if(!(this.selectedTicket.getCodestatus().equalsIgnoreCase(TicketsConstants.TICKET_SOLVENTA_RESOLVED) || 
//				this.selectedTicket.getCodestatus().equalsIgnoreCase(TicketsConstants.TICKET_CLOSE)))
//		{
//			//Close Button
//			Button btn_CloseTicket = new Button(I18NManager.getI18NString(BbrUtilsResources.RES_MODULES_TICKETS, "close_ticket"));
//			btn_CloseTicket.setStyleName("primary");
//			btn_CloseTicket.addStyleName("btn-login");
//			btn_CloseTicket.setWidth("170px");
//			btn_CloseTicket.addClickListener((ClickListener & Serializable) e -> btnClose_clickHandler(e));
//			
//			this.buttonsPanel.addComponent(btn_CloseTicket);
//		}
//		
//
//		//Cancel Button
...
//	{
//		SendVendorTicketOperation winVendorTicketOperation 
//		= new SendVendorTicketOperation(this.selectedTicket,this.vendorId, this.vendorName,EnumTicketOperation.CLOSE);
...
//
//	
//	private void btnAccept_clickHandler(ClickEvent e) 
//	{
//		VendorTicketOperationInfo vendorTicketOperationInfo = new VendorTicketOperationInfo(selectedTicket, vendorId, vendorName, this.ckEditorTextField.getValue(), EnumTicketOperation.ACCEPT);
//		this.doTicketOperation(vendorTicketOperationInfo);
//	}
//
//	private void btnReopen_clickHandler(ClickEvent e) 
//	{
//		SendVendorTicketOperation winVendorTicketOperation 
//		= new SendVendorTicketOperation(this.selectedTicket,this.vendorId, this.vendorName,EnumTicketOperation.REOPEN);
//		winVendorTicketOperation.initializeView();
//		winVendorTicketOperation.addBbrEventListener((BbrEventListener & Serializable) event -> sendTicketOperation_handler(event));		
//		winVendorTicketOperation.open(this.getParentUI(), true);	
//	}
...
//	{
//		SendVendorTicketOperation winVendorTicketOperation 
//		= new SendVendorTicketOperation(this.selectedTicket,this.vendorId, this.vendorName,EnumTicketOperation.REPLY);
//		winVendorTicketOperation.initializeView();
//		winVendorTicketOperation.addBbrEventListener((BbrEventListener & Serializable) event -> sendTicketOperation_handler(event));		
//		winVendorTicketOperation.open(this.getParentUI(), true);	
//	}
...
//			try 
//			{
//				TicketDetailReportResultDTO ticketResult = EJBFactory.getTicketsEJBFactory().getTicketReportManagerLocal().getVendorTicketDetailReport(initParams);
...
//	}
//	
//	private void doTicketOperation(VendorTicketOperationInfo vendorTicketOperationInfo) 
//	{
//		String message = "";
...
//			{
//				VendorTicketInitParamDTO initParams = vendorTicketOperationInfo.toVendorTicketInitParamDTO();
//
//				ticketResult 	= EJBFactory.getTicketsEJBFactory().getTicketReportManagerLocal().doAcceptVendorTicket(initParams);
//		
...
//				this.sendTicketOperation_handler(createEvent);
//				
//				this.showInfoMessage(I18NManager.getI18NString(BbrUtilsResources.RES_GENERIC, "windows_title_info"), I18NManager.getI18NString(BbrUtilsResources.RES_MODULES_TICKETS, "ticket_closed"));
//			}
//		}
//	}
//	// ****************************************************************************************
