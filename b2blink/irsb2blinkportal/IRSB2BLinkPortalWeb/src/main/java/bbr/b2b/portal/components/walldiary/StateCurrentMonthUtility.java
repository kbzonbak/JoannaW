...
public class StateCurrentMonthUtility extends VerticalLayout
{
	...
	public StateCurrentMonthUtility(BbrUI bbrUI, double utility)
	{
		this.bbrUI = bbrUI;
	...
	private void initializeControl()
	{
		if (bbrUI != null && bbrUI.getUser() != null)
		{
			...
			Resource res = BbrThemeResourcesUtils.getInstance().getResource(bbrUI, CoreConstants.PATH_BASE_IMAGES_WALLDIARY + "state_current_month_utility.png");
	...
	private HorizontalLayout getToolBar()
	{
		...
		Label headerCaption = new Label(I18NManager.getI18NString(bbrUI, BbrUtilsResources.RES_MODULES_WALLDIARY, "utility"));
	...
	public void updateData(double utility, LocalDateTime localDate)
	{
		if (localDate != null)
		{
			this.utility = utility;
			...
			String dataValue = String.valueOf(df.format(this.utility / 1000000));
