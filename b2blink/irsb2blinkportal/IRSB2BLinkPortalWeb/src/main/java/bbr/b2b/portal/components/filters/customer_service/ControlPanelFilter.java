...
public class ControlPanelFilter extends BbrFilterContainer implements Button.ClickListener
{
	...
	public ControlPanelFilter(BbrModule parentModule)
	{
		super(parentModule);
	}
	// =====================================================================================================================================
	...
	public void buttonClick(ClickEvent event)
	{
		...
		else
		{
			...
			ControlPanelFilter.this.showWarningMessage(I18NManager.getI18NString(BbrUtilsResources.RES_GENERIC, "windows_title_warning"), errorMsg);
		}
	}
