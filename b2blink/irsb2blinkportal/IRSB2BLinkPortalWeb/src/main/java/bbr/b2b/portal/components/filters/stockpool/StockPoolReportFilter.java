...
public class StockPoolReportFilter extends BbrFilterContainer implements Button.ClickListener
{
	...
	public StockPoolReportFilter(BbrModule parentModule)
	{
		super(parentModule);
	}
	// =====================================================================================================================================
	...
	public void buttonClick(ClickEvent event)
	{
		...
		else
		{
			...
			StockPoolReportFilter.this.showWarningMessage(I18NManager.getI18NString(BbrUtilsResources.RES_GENERIC, "windows_title_warning"), errorMsg);
		}
	}
