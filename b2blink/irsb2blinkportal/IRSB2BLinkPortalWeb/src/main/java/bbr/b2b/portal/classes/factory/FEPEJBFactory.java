...
import bbr.b2b.portal.fep.commercial.managers.classes.FEPCategoryProductManagerLocal;
import bbr.b2b.portal.fep.commercial.managers.classes.FEPCommercialReportManagerLocal;
import bbr.b2b.portal.fep.commercial.managers.classes.FEPProductReportManagerLocal;
import bbr.b2b.portal.fep.managers.classes.FEPCommonDataManagerLocal;
import bbr.b2b.portal.fep.managers.classes.FEPCreateProductManagerLocal;
import bbr.b2b.portal.fep.managers.classes.FEPFileStorageManagerLocal;
import bbr.b2b.portal.fep.managers.classes.FEPModifyProductManagerLocal;
...
public class FEPEJBFactory {

	// ****************************************************************************************
		// BEGINNING SECTION ----> PROPERTIES
		// ****************************************************************************************
		private static FEPEJBFactory _instance = new FEPEJBFactory();
		...
		// ****************************************************************************************
		public FEPCommonDataManagerLocal getFEPCommonDataManagerLocal() throws BbrUserException, BbrSystemException
		{
			return getFEPCommonDataManagerLocal((BbrUI) UI.getCurrent());
		}

		public FEPCommonDataManagerLocal getFEPCommonDataManagerLocal(BbrUI bbrUI) throws BbrUserException, BbrSystemException
		{
			this.validateUserSystem(bbrUI);
			FEPCommonDataManagerLocal manager = (FEPCommonDataManagerLocal) getEJBHomes("FEPCommonDataManagerLocal");
			return manager;
		}

		public FEPCommonDataManagerLocal getFEPCommonDataManagerLocal(BbrUI bbrUI, String companycode) throws BbrUserException, BbrSystemException
		{
		...
		public FEPCreateProductManagerLocal getFEPCreateProductManagerLocal() throws BbrUserException, BbrSystemException
		{
			return getFEPCreateProductManagerLocal((BbrUI) UI.getCurrent());
		}

		public FEPCreateProductManagerLocal getFEPCreateProductManagerLocal(BbrUI bbrUI) throws BbrUserException, BbrSystemException
		{
			this.validateUserSystem(bbrUI);
			FEPCreateProductManagerLocal manager = (FEPCreateProductManagerLocal) getEJBHomes("FEPCreateProductManagerLocal");
			return manager;
		}

		public FEPCreateProductManagerLocal getFEPCreateProductManagerLocal(BbrUI bbrUI, String companycode) throws BbrUserException, BbrSystemException
		{
			Long userid = this.validateUserSystem(bbrUI);
			this.isCompanyAssignedToUser(userid, companycode);
			FEPCreateProductManagerLocal manager = (FEPCreateProductManagerLocal) getEJBHomes("FEPCreateProductManagerLocal");
		...
		public FEPModifyProductManagerLocal getFEPModifyProductManagerLocal() throws BbrUserException, BbrSystemException
		{
			return getFEPModifyProductManagerLocal((BbrUI) UI.getCurrent());
		}

		public FEPModifyProductManagerLocal getFEPModifyProductManagerLocal(BbrUI bbrUI) throws BbrUserException, BbrSystemException
		{
			this.validateUserSystem(bbrUI);
			FEPModifyProductManagerLocal manager = (FEPModifyProductManagerLocal) getEJBHomes("FEPModifyProductManagerLocal");
			return manager;
		}

		public FEPModifyProductManagerLocal getFEPModifyProductManagerLocal(BbrUI bbrUI, String companycode) throws BbrUserException, BbrSystemException
		{
			Long userid = this.validateUserSystem(bbrUI);
			this.isCompanyAssignedToUser(userid, companycode);
			FEPModifyProductManagerLocal manager = (FEPModifyProductManagerLocal) getEJBHomes("FEPModifyProductManagerLocal");
		...
		public FEPFileStorageManagerLocal getFileStorageManagerLocal() throws BbrUserException, BbrSystemException
		{
			return getFEPFileStorageManagerLocal((BbrUI) UI.getCurrent());
		}

		public FEPFileStorageManagerLocal getFEPFileStorageManagerLocal(BbrUI bbrUI) throws BbrUserException, BbrSystemException
		{
			this.validateUserSystem(bbrUI);
			FEPFileStorageManagerLocal manager = (FEPFileStorageManagerLocal) getEJBHomes("FEPFileStorageManagerLocal");
			return manager;
		}

		public FEPFileStorageManagerLocal getFEPFileStorageManagerLocal(BbrUI bbrUI, String companycode) throws BbrUserException, BbrSystemException
		{
			Long userid = this.validateUserSystem(bbrUI);
			this.isCompanyAssignedToUser(userid, companycode);
			FEPFileStorageManagerLocal manager = (FEPFileStorageManagerLocal) getEJBHomes("FEPFileStorageManagerLocal");
		...
		//MDM COMMERCIAL
		public FEPCommercialReportManagerLocal getFEPCommercialReportManagerLocal() throws BbrUserException, BbrSystemException
		{	
			return getFEPCommercialReportManagerLocal((BbrUI) UI.getCurrent());
		}

		public FEPCommercialReportManagerLocal getFEPCommercialReportManagerLocal(BbrUI bbrUI) throws BbrUserException, BbrSystemException
		{	
			return getFEPCommercialReportManagerLocal(bbrUI, null);
		}

		public FEPCommercialReportManagerLocal getFEPCommercialReportManagerLocal(BbrUI bbrUI,String companycode) throws BbrUserException, BbrSystemException
		{	
			UserDTO userDTO = this.validateUserSystemCommercial(bbrUI);
			this.isCompanyAssignedToUser(userDTO.getId(), companycode, userDTO.getAllenterprises());

			FEPCommercialReportManagerLocal manager = (FEPCommercialReportManagerLocal)getEJBHomes("FEPCommercialReportManagerLocal");
			return manager;
		}

		public FEPProductReportManagerLocal getFEPProductReportManagerLocal() throws BbrUserException, BbrSystemException
		{	
			return getFEPProductReportManagerLocal((BbrUI) UI.getCurrent());

		}

		public FEPProductReportManagerLocal getFEPProductReportManagerLocal(BbrUI bbrUI) throws BbrUserException, BbrSystemException
		{	
			return getFEPProductReportManagerLocal(bbrUI, null);
		}

		public FEPProductReportManagerLocal getFEPProductReportManagerLocal(BbrUI bbrUI, String companycode) throws BbrUserException, BbrSystemException
		{

			UserDTO userDTO = this.validateUserSystemCommercial(bbrUI);
			this.isCompanyAssignedToUser(userDTO.getId(), companycode, userDTO.getAllenterprises());

			FEPProductReportManagerLocal manager = (FEPProductReportManagerLocal)getEJBHomes("FEPProductReportManagerLocal");
			return manager;
		}

		public FEPCategoryProductManagerLocal getFEPCategoryProductManagerLocal() throws BbrUserException, BbrSystemException
		{	
			return getFEPCategoryProductManagerLocal((BbrUI) UI.getCurrent());
		}

		public FEPCategoryProductManagerLocal getFEPCategoryProductManagerLocal(BbrUI bbrUI) throws BbrUserException, BbrSystemException
		{	
			return getFEPCategoryProductManagerLocal(bbrUI, null);
		}

		public FEPCategoryProductManagerLocal getFEPCategoryProductManagerLocal(BbrUI bbrUI,String companycode) throws BbrUserException, BbrSystemException
		{	
			UserDTO userDTO = this.validateUserSystemCommercial(bbrUI);
			this.isCompanyAssignedToUser(userDTO.getId(), companycode, userDTO.getAllenterprises());

			FEPCategoryProductManagerLocal manager = (FEPCategoryProductManagerLocal)getEJBHomes("FEPCategoryProductManagerLocal");
		...
		// ****************************************************************************************
		protected static FEPEJBFactory getFactory()
		{
			return _instance;
		}
