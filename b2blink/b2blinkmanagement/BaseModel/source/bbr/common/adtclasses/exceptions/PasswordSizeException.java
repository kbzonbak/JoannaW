...
public class PasswordSizeException extends ServiceException {
	 ...
	 */
	public PasswordSizeException(String friendlymessage, String message) {
	 ...
	 *            the friendly detail message.
	 */
	public PasswordSizeException(String friendlymessage, Exception e) {
