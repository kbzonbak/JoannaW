package bbr.esb.storage.managers;
...
public class FileServiceManager implements FileServiceManagerLocal{
	...
	private static Logger LOGGER= Logger.getLogger(FileServiceManager.class);
	
	String endpoint = System.getProperty("S3_ENDPOINT");
	String accessKey = System.getProperty("S3_ACCESS_KEY");
	String secretKey = System.getProperty("S3_SECRET_KEY");
	String regionName = System.getProperty("S3_REGION");
