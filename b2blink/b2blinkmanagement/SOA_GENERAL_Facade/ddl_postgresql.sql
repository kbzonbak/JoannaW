    ...
    alter table public.FILE_EVENT 
        drop constraint FKD290BDF7D3C89F69;

    alter table public.FILE_EVENT 
        drop constraint FKD290BDF7A1DED1ED;

    alter table public.FILE_EVENT 
        drop constraint FKD290BDF7751CB327;
    ...
    alter table public.FILE_EVENT 
        add constraint FKD290BDF7D3C89F69 
        foreign key (COMPANY_ID) 
        references public.COMPANY;

    alter table public.FILE_EVENT 
        add constraint FKD290BDF7A1DED1ED 
        foreign key (SITE_ID) 
        references public.SITE;

    alter table public.FILE_EVENT 
        add constraint FKD290BDF7751CB327 
        foreign key (SERVICE_ID) 
        references public.SERVICE;
