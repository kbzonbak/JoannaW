 ...
 *         &lt;element name="Custom" type="{http://xmlns.cencosud.corp/Core/EBO/UBL/Custom-UBL-CommonAggregateComponents-2.0}CustomAddressLineType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class AddressLineType {
    ...
    protected CustomAddressLineType custom;
     ...
     * @return
     *     possible object is
     *     {@link CustomAddressLineType }
     *     
     */
    public CustomAddressLineType getCustom() {
        return custom;
    }
     ...
     *     
     */
    public void setCustom(CustomAddressLineType value) {
        this.custom = value;
    }
