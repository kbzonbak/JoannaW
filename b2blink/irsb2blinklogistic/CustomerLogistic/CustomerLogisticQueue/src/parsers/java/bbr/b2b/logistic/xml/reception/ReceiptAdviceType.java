...
@XmlType(name = "ReceiptAdviceType", namespace = "urn:oasis:names:specification:ubl:schema:xsd:ReceiptAdvice-2", propOrder = {
    "ublExtensions",
    "ublVersionID",
    "customizationID",
    "profileID",
...
public class ReceiptAdviceType {
    ...
    protected DocumentStatusCodeType2 documentStatusCode;
     ...
     * @return
     *     possible object is
     *     {@link DocumentStatusCodeType2 }
     *     
     */
    public DocumentStatusCodeType2 getDocumentStatusCode() {
     ...
     *     
     */
    public void setDocumentStatusCode(DocumentStatusCodeType2 value) {
