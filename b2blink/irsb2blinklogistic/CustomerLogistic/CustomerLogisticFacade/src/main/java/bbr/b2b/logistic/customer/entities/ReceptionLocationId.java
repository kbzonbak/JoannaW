...
public class ReceptionLocationId implements IReceptionLocatioPK {

	private Long receptionid;
	private Long locationid;

	public ReceptionLocationId(){
	}
	public ReceptionLocationId(Long receptionid, Long locationid){
		this.receptionid = receptionid;
		this.locationid = locationid;
	}

	public boolean equals(Object o){
		if (o != null && o instanceof ReceptionLocationId){
			ReceptionLocationId that = (ReceptionLocationId) o;
