...
public class DetaildiscountPK implements IDetaildiscountPK {

	private Long orderid;
	private String skubuyer;
	private Integer position;

	public DetaildiscountPK(){
	}
	public DetaildiscountPK(Long orderid, String skubuyer,Integer position){
	...
	public boolean equals(Object o){
		if (o != null && o instanceof DetaildiscountPK){
	...
	public int hashCode() {
		return orderid.hashCode() + skubuyer.hashCode();
	}
