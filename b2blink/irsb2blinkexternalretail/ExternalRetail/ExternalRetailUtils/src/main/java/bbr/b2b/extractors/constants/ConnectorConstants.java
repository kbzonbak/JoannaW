package bbr.b2b.extractors.constants;
...
public class ConnectorConstants extends Constants {
	
	static Logger logger = Logger.getLogger(ConnectorConstants.class);

	private static ConnectorConstants _instance;
	...
	// Constructor
	public static synchronized ConnectorConstants getInstance() {
		if (_instance == null) {
			
			_instance = new ConnectorConstants();
