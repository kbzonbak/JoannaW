...
public class OrderResponseDTO {
	...
	private String total_returned;
	private String total_found;
	private String limit;
	private List<PurchaseOrderDTO> purchase_order_list;
	...
	public List<PurchaseOrderDTO> getPurchase_order_list() {
		return purchase_order_list;
	}
	public void setPurchase_order_list(List<PurchaseOrderDTO> purchase_order_list) {
