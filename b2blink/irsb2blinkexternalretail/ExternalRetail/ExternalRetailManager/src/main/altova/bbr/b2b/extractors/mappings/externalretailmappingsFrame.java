/**
 * externalretailmappingsFrame.java
 *
...
public class externalretailmappingsFrame extends JFrame implements com.altova.TraceTarget {
	...
	JLabel jORDERSLabel0 = new JLabel();
	JTextField jORDERSTextField0 = new JTextField();

	JLabel jOC_CustomerLabel1 = new JLabel();
	JTextField jOC_CustomerTextField1 = new JTextField();


	public externalretailmappingsFrame() {
	...
	private void jbInit() throws Exception {
		jInfoLabel1.setText("THIS APPLICATION WAS GENERATED BY MapForce 2011r3sp1");
		...
		jIconLabel.setIcon(new ImageIcon(externalretailmappingsFrame.class.getResource("mapforce.png")));
		jIconLabel.setText("");
		...
		jStartButton.addActionListener(new externalretailmappingsFrame_jStartButton_actionAdapter(this));
	...
	protected void fillScrollPane() {
		...
		jORDERSLabel0.setText("Source instance of ORDERS file:");
		jORDERSLabel0.setBounds(new Rectangle(15, 10, 438, 23));
		jPanelStructures.add(jORDERSLabel0, null);
		jORDERSTextField0.setText("ejemplos/walmart.edi");
		jORDERSTextField0.setBounds(new Rectangle(15, 35, 438, 23));
		jORDERSTextField0.setEditable(false);
		jPanelStructures.add(jORDERSTextField0, null);

		jOC_CustomerLabel1.setText("Instance of OC_Customer.xsd:");
		jOC_CustomerLabel1.setBounds(new Rectangle(15, 60, 438, 23));
		jPanelStructures.add(jOC_CustomerLabel1, null);
		jOC_CustomerTextField1.setText("xsd/OC_Customer.xml");
		jOC_CustomerTextField1.setBounds(new Rectangle(15, 85, 438, 23));
		jOC_CustomerTextField1.setEditable(false);
		jPanelStructures.add(jOC_CustomerTextField1, null);
...
class externalretailmappingsFrame_jStartButton_actionAdapter
	implements java.awt.event.ActionListener {
	externalretailmappingsFrame adaptee;

	externalretailmappingsFrame_jStartButton_actionAdapter(externalretailmappingsFrame adaptee) {
