...
@XmlRootElement(name = "SolicitudProveedoresVentasPendientes")
public class SolicitudProveedoresVentasPendientes {

    @XmlElement(required = true)
    protected String codcomprador;
    protected String nombreportal;
    @XmlElement(name = "Proveedores", required = true)
    protected SolicitudProveedoresVentasPendientes.Proveedores proveedores;
     ...
     * @return
     *     possible object is
     *     {@link SolicitudProveedoresVentasPendientes.Proveedores }
     *     
     */
    public SolicitudProveedoresVentasPendientes.Proveedores getProveedores() {
        return proveedores;
    }
     ...
     *     
     */
    public void setProveedores(SolicitudProveedoresVentasPendientes.Proveedores value) {
    ...
    public static class Proveedores {
        ...
        protected List<SolicitudProveedoresVentasPendientes.Proveedores.Proveedor> proveedor;
         ...
         * {@link SolicitudProveedoresVentasPendientes.Proveedores.Proveedor }
         * 
         * 
         */
        public List<SolicitudProveedoresVentasPendientes.Proveedores.Proveedor> getProveedor() {
            if (proveedor == null) {
                proveedor = new ArrayList<SolicitudProveedoresVentasPendientes.Proveedores.Proveedor>();
            }
