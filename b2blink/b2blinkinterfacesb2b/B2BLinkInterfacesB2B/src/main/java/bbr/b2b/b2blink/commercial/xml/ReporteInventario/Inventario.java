...
public class Inventario {
    ...
    @XmlElement(required = true)
    protected Inventario.Comprador comprador;
    @XmlElement(required = true)
    protected Inventario.Vendedor vendedor;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link Inventario.Comprador }
     *     
     */
    public Inventario.Comprador getComprador() {
        return comprador;
    }
     ...
     *     
     */
    public void setComprador(Inventario.Comprador value) {
     ...
     * @return
     *     possible object is
     *     {@link Inventario.Vendedor }
     *     
     */
    public Inventario.Vendedor getVendedor() {
        return vendedor;
    }
     ...
     *     
     */
    public void setVendedor(Inventario.Vendedor value) {
        this.vendedor = value;
    }
