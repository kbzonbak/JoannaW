...
public class Ventas {
    ...
    @XmlElement(required = true)
    protected Ventas.Comprador comprador;
    @XmlElement(required = true)
    protected Ventas.Vendedor vendedor;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link Ventas.Comprador }
     *     
     */
    public Ventas.Comprador getComprador() {
        return comprador;
    }
     ...
     *     
     */
    public void setComprador(Ventas.Comprador value) {
     ...
     * @return
     *     possible object is
     *     {@link Ventas.Vendedor }
     *     
     */
    public Ventas.Vendedor getVendedor() {
        return vendedor;
    }
     ...
     *     
     */
    public void setVendedor(Ventas.Vendedor value) {
        this.vendedor = value;
    }
