...
@XmlRootElement(name = "SolicitudProveedoresRecPendientes")
public class SolicitudProveedoresRecPendientes {

    @XmlElement(required = true)
    protected String codcomprador;
    protected String nombreportal;
    @XmlElement(name = "Proveedores", required = true)
    protected SolicitudProveedoresRecPendientes.Proveedores proveedores;
     ...
     * @return
     *     possible object is
     *     {@link SolicitudProveedoresRecPendientes.Proveedores }
     *     
     */
    public SolicitudProveedoresRecPendientes.Proveedores getProveedores() {
        return proveedores;
    }
     ...
     *     
     */
    public void setProveedores(SolicitudProveedoresRecPendientes.Proveedores value) {
    ...
    public static class Proveedores {
        ...
        protected List<SolicitudProveedoresRecPendientes.Proveedores.Proveedor> proveedor;
         ...
         * {@link SolicitudProveedoresRecPendientes.Proveedores.Proveedor }
         * 
         * 
         */
        public List<SolicitudProveedoresRecPendientes.Proveedores.Proveedor> getProveedor() {
            if (proveedor == null) {
                proveedor = new ArrayList<SolicitudProveedoresRecPendientes.Proveedores.Proveedor>();
            }
