...
@XmlRootElement(name = "SolicitudProveedoresOrdenesPendientes")
public class SolicitudProveedoresOrdenesPendientes {

    @XmlElement(required = true)
    protected String codcomprador;
    protected String nombreportal;
    @XmlElement(name = "Proveedores", required = true)
    protected SolicitudProveedoresOrdenesPendientes.Proveedores proveedores;
     ...
     * @return
     *     possible object is
     *     {@link SolicitudProveedoresOrdenesPendientes.Proveedores }
     *     
     */
    public SolicitudProveedoresOrdenesPendientes.Proveedores getProveedores() {
        return proveedores;
    }
     ...
     *     
     */
    public void setProveedores(SolicitudProveedoresOrdenesPendientes.Proveedores value) {
    ...
    public static class Proveedores {
        ...
        protected List<SolicitudProveedoresOrdenesPendientes.Proveedores.Proveedor> proveedor;
         ...
         * {@link SolicitudProveedoresOrdenesPendientes.Proveedores.Proveedor }
         * 
         * 
         */
        public List<SolicitudProveedoresOrdenesPendientes.Proveedores.Proveedor> getProveedor() {
            if (proveedor == null) {
                proveedor = new ArrayList<SolicitudProveedoresOrdenesPendientes.Proveedores.Proveedor>();
            }
