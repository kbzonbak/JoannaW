...
// Generado el: 2020.11.12 a las 04:24:56 PM CLST 
//


package bbr.b2b.b2blink.logistic.xml.InventarioCliente;
...
@XmlRootElement(name = "InventarioCliente")
public class InventarioCliente {
    ...
    protected InventarioCliente.Comprador comprador;
    @XmlElement(required = true)
    protected InventarioCliente.Detalles detalles;
     ...
     * @return
     *     possible object is
     *     {@link InventarioCliente.Comprador }
     *     
     */
    public InventarioCliente.Comprador getComprador() {
        return comprador;
    }
     ...
     *     
     */
    public void setComprador(InventarioCliente.Comprador value) {
     ...
     * @return
     *     possible object is
     *     {@link InventarioCliente.Detalles }
     *     
     */
    public InventarioCliente.Detalles getDetalles() {
        return detalles;
    }
     ...
     *     
     */
    public void setDetalles(InventarioCliente.Detalles value) {
        this.detalles = value;
    }
    ...
    public static class Detalles {
        ...
        @XmlElement(required = true)
        protected List<InventarioCliente.Detalles.Detalle> detalle;
         ...
         * {@link InventarioCliente.Detalles.Detalle }
         * 
         * 
         */
        public List<InventarioCliente.Detalles.Detalle> getDetalle() {
            if (detalle == null) {
                detalle = new ArrayList<InventarioCliente.Detalles.Detalle>();
            }
            return this.detalle;
        }
